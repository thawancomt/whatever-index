    ...
    return (
        <Card className={
                ...
                hasResult && (
                    <CardHeader className="flex flex-col items-start">
                        ...
                        <div className="w-full flex overflow-x-auto">
                            ...
                            {
                                (Object.keys(ExtensionDomains) as (keyof typeof ExtensionDomains)[]).map(domain => {
                                    const count = mappedByDomain[domain]?.length || 0;
                                    if (count === 0) return null;
                                    return <Button key={domain} variant={"secondary"} className=" inline-flex items-center gap-2">
                                        <span>
                                            {domain}
                                        </span>
            ...
            <CardContent className={
                cn(
                    hasResult ? "flex flex-col gap-2" : "flex  grow justify-center items-center"
                )
            }>
...

                        {
                            ...
                            !hasResult && !hasQuery && (
                                <div className="flex flex-col justify-center items-center gap-2">
                                    ...
                                    <h1>
                                        Start searching for content in your files
                                    </h1>
                                </div>
                            )
                        }
